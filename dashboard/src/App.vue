...
const adminPaths = ['/fleet', '/entities', '/crawls', '/page-explorer', '/chat-preview', '/ministry-requests', '/logs', '/api-keys', '/audit-log']
...
const adminNavItems = [
  ...
  { title: 'Audit Log', icon: 'mdi-clipboard-text-clock', to: '/audit-log' },
]
